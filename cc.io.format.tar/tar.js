/////////////////////////////////////////////////////////////////////////////////////
//
// module 'cc.io.format.tar.1.0.1/'
//
/////////////////////////////////////////////////////////////////////////////////////
(function() {
    var require = define.getRequire("cc.io.format.tar.1.0.1/");
    define.parameters = {};
    define.parameters.system = "pkx";
    define.parameters.id = "cc.io.format.tar.1.0.1/";
    define.parameters.pkx = {
        "company": "cc",
        "product": "",
        "name": "io",
        "component": "format.tar",
        "version": "1.0.1",
    ...
    (function(){
        function Tar(pkx, module) {
            ...
            this.TarObject = function(header)
            {
                var self = this;
            ...
            this.TarReader = function(stream)
            {
                var self = this;
                ...
                function probe()
                {
                    return new Promise(function(resolve, refuse) {
                        stream.seek(0, io.SEEKORIGIN_BEGIN).then(function() {
                            stream.read(HEADER_SIZE).then(function (header) {
                ...
                function readMetadata() {
                    return new Promise(function(resolve, refuse) {
                        ...
                        stream.seek(0).then(readNext, refuse);
                    });
                }
                function readNextHeader() {
                    return new Promise(function readTarHeader(resolve, refuse) {
                        stream.read(HEADER_SIZE).then(function processTarHeader(header) {
                            var tT = new own.TarTag("object" + objectCount, own.TAR_TAG_TYPE_OBJECT, header);
                            ...
                            stream.seek(streamPosition).then(resolve, refuse);
            ...
            this.TarTag = function(key, type, data)
            {
                this.key = key;
                this.type = type;
            ...
            this.TarVolume = function(stream) {
                var self = this;
                ...
                this.open = function(path) {
                    ...
                    return new Promise(function(resolve, refuse) {
                        for(var t=0;t<tarReader.metadata.tags.length;t++) {
                            ...
                            if (tarReader.metadata.tags[t].value.name == relPath) {
                ...
                function init(resolve, refuse) {
                    ...
                    tarReader = new own.TarReader(stream);
...
//# sourceURL=http://cc.io.format.tar.1.0.1/tar.js
